...
public class ControlCode {
    ...
    public String generate(String aNumber, String iNumber, String nitci, 
        ...
        String string1 = dosageKey.substring(0, numbers[0] ).trim();
        String string2 = dosageKey.substring(numbers[0], numbers[0]+numbers[1] ).trim();
        String string3 = dosageKey.substring(numbers[0]+numbers[1], numbers[0]+numbers[1]+numbers[2] ).trim();
        String string4 = dosageKey.substring(numbers[0]+numbers[1]+numbers[2], numbers[0]+numbers[1]+numbers[2]+numbers[3] ).trim();
        String string5 = dosageKey.substring(numbers[0]+numbers[1]+numbers[2]+numbers[3], numbers[0]+numbers[1]+numbers[2]+numbers[3]+numbers[4] ).trim();
